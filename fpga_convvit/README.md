...
- [x] Phase 1–3: M2-Optimized Data Pipeline & Spectrogram Caching
- [x] Phase 4–6: ConvViT Training & INT8 Optimization
- [x] Phase 7–8: Jamming Robustness & FPGA Resource Mapping
- [ ] Phase 9: Real-world Hardware Deployment on Zynq UltraScale+
